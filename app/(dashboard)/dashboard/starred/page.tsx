    ...
    return (<>
        <div className='flex flex-col p-10 gap-6'>
            <div className="flex w-full items-center justify-between space-x-4">
                <div className="">
                    <h1 className='text-3xl text-slate-800 font-semibold mb-2'>Starred Notes</h1>
                    <p className='text-slate-600'>All your starred notes at one place, keep starring!</p>
                </div>
            </div>
